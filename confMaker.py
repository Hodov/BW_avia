...
for originItem in originList:
	...
	for i in data:
		...
		dataJSON["alerts"].append({'name': name, 'format': 'short', 'method': 'last_value', 'no_data': 'normal', 'history_size': '1day', 'query': metrica, 'rules': ['critical: < historical*0.5', 'warning: < historical*0.75']})


with open('beaconConf.json', 'w') as f:
